    ...
    <Layout>
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center pt-20 overflow-hidden group">
        ...
        <div className="container-wide relative z-10 px-6 md:px-0">
          <div className="max-w-3xl animate-in slide-in-from-bottom duration-1000">
            ...
            <p className="text-white/90 text-xl md:text-2xl leading-relaxed max-w-2xl drop-shadow-md">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-in slide-in-from-left duration-700 delay-200">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="font-serif text-3xl md:text-5xl font-bold text-foreground">Who We Are</h2>
              </div>
            ...
            {/* Mobile Stacked / Desktop Absolute Collage */}
            <div className="relative h-auto md:h-[500px] w-full flex flex-col md:block gap-6">
              <div className="relative md:absolute top-0 right-0 w-full md:w-4/5 h-64 md:h-4/5 rounded-3xl overflow-hidden shadow-2xl z-10 transform hover:scale-[1.02] transition-transform duration-500">
                <img src={pic1} alt="Team Meeting" className="w-full h-full object-cover" />
              </div>
              <div className="relative md:absolute bottom-0 left-0 w-full md:w-3/5 h-64 md:h-3/5 rounded-3xl overflow-hidden shadow-2xl z-20 border-0 md:border-8 md:border-background transform md:-rotate-3 hover:rotate-0 transition-transform duration-500">
                <img src={pic2} alt="Collaborators" className="w-full h-full object-cover" />
              </div>
              <div className="hidden md:flex absolute top-1/4 -left-10 w-1/3 h-1/3 rounded-2xl overflow-hidden shadow-xl z-0 bg-primary/10 backdrop-blur-sm border border-primary/20 items-center justify-center p-4">
      ...
      <section className="py-20 md:py-32 bg-[#fffcf5] border-y border-amber-100/50 overflow-hidden">
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Mobile Stacked / Desktop Absolute Collage */}
            <div className="relative h-auto md:h-[500px] w-full order-2 lg:order-1 flex flex-col md:block gap-6">
              <div className="relative md:absolute top-10 left-0 w-full md:w-3/4 h-64 md:h-3/4 rounded-3xl md:rounded-full overflow-hidden shadow-2xl z-10 border-0 md:border-4 md:border-primary/20">
                <img src={pic3} alt="Visionary Community" className="w-full h-full object-cover object-top" />
              </div>
              <div className="relative md:absolute bottom-10 right-0 w-full md:w-1/2 h-64 md:h-1/2 rounded-3xl overflow-hidden shadow-2xl z-20 transform md:rotate-6 hover:rotate-0 transition-all duration-500">
                <img src={pic4} alt="Educational Practice" className="w-full h-full object-cover" />
              </div>
              <div className="hidden md:block absolute top-0 right-1/4 w-24 h-24 bg-gold rounded-full z-0 animate-pulse opacity-20"></div>
            </div>
            <div className="space-y-8 order-1 lg:order-2">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="font-serif text-3xl md:text-5xl font-bold text-foreground">Our Vision</h2>
              </div>
              <p className="text-muted-foreground text-lg md:text-xl leading-relaxed italic border-l-4 border-primary pl-6 py-2">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="font-serif text-3xl md:text-5xl font-bold text-foreground">Our Goals</h2>
              </div>
              <p className="text-muted-foreground text-lg md:text-xl leading-relaxed">
            ...
            <div className="relative h-[600px] w-full flex flex-col gap-4">
              ...
              <div className="flex flex-col md:flex-row gap-4 h-1/2">
                <div className="w-full md:w-2/3 h-full rounded-3xl overflow-hidden shadow-xl group">
                ...
                <div className="hidden md:block w-1/3 h-full rounded-3xl overflow-hidden shadow-xl group">
      ...
      <section className="py-20 md:py-32 bg-background overflow-hidden">
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Mobile Grid / Desktop Rotated Grid */}
            <div className="relative h-auto md:h-[600px] w-full grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-4 order-2 lg:order-1">
              <div className="h-64 md:h-auto rounded-3xl overflow-hidden shadow-lg transform md:rotate-2 hover:rotate-0 transition-transform duration-500">
                <img src={award1} alt="Award 1" className="w-full h-full object-cover" />
              </div>
              <div className="h-64 md:h-auto rounded-3xl overflow-hidden shadow-lg md:mt-12 transform md:-rotate-1 hover:rotate-0 transition-transform duration-500">
                <img src={award2} alt="Award 2" className="w-full h-full object-cover" />
              </div>
              <div className="h-64 md:h-auto rounded-3xl overflow-hidden shadow-lg md:mb-12 transform md:-rotate-2 hover:rotate-0 transition-transform duration-500">
                <img src={award3} alt="Award 3" className="w-full h-full object-cover" />
              </div>
              <div className="h-64 md:h-auto rounded-3xl overflow-hidden shadow-lg transform md:rotate-1 hover:rotate-0 transition-transform duration-500">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="font-serif text-3xl md:text-5xl font-bold text-foreground font-semibold">Our Services</h2>
              </div>
